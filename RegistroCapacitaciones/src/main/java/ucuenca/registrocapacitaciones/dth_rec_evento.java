...
public class dth_rec_evento implements java.io.Serializable
{
   ...
   private java.util.List<ucuenca.registrocapacitaciones.dth_rec_participante> participantes;
   ...
   public java.util.List<ucuenca.registrocapacitaciones.dth_rec_participante> getParticipantes()
   {
      return this.participantes;
   }

   public void setParticipantes(
         java.util.List<ucuenca.registrocapacitaciones.dth_rec_participante> participantes)
   {
